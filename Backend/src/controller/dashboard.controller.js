...
// GET /dashboard/user-utilization?range=monthly
...
//     } else {
//       dateCondition = 'AND MONTH(d.date) = MONTH(CURDATE()) AND YEAR(d.date) = YEAR(CURDATE())';
//     }
...
//       // const availableHours = row.daily_capacity ;
