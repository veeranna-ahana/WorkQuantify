...
//                 <th style={{ border: '1px solid #ccc', padding: '8px' }}>Working Days</th>
//                 <th style={{ border: '1px solid #ccc', padding: '8px' }}>Capacity</th>
//                 <th style={{ border: '1px solid #ccc', padding: '8px' }}>Available Hours</th>
//                 <th style={{ border: '1px solid #ccc', padding: '8px' }}>Utilization %</th>
//               </tr>
//             </thead>
//             <tbody>
...
//                   <td style={{ border: '1px solid #ccc', padding: '8px' }}>{user.total_hours}</td>
//                   <td style={{ border: '1px solid #ccc', padding: '8px' }}>{user.working_days}</td>
//                   <td style={{ border: '1px solid #ccc', padding: '8px' }}>{user.daily_capacity}</td>
//                   <td style={{ border: '1px solid #ccc', padding: '8px' }}>{user.available_hours}</td>
//                   <td
//                     style={{
...
//           </table>
//         ) : (
//           <div style={{ marginTop: '12px' }}>No utilization data available.</div>
//         )}
//       </div>
//     </div>
//   );
